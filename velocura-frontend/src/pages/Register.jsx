...
export default function Register() {
  ...
  useEffect(() => {
    const clientId = import.meta.env.VITE_GOOGLE_CLIENT_ID || "750331264882-crdl5gjg144tsm7453u74lq5hvd3ag5c.apps.googleusercontent.com";
    if (!clientId) return;
  ...
  const handleCustomGoogleClick = () => {
    ...
    if (window.google?.accounts?.id && clientId) {
      ...
      setError("Google Sign-Up is initializing. Please wait a moment.");
    }
  };
      ...
      <div className={s.authCard} style={{ maxWidth: "440px" }}>
        ...
        <form onSubmit={handleInitiateRegistration} className={s.form}>
          ...
          <div className={s.googleBtnWrapper}>
            <div ref={googleBtnContainerRef} className={s.googleNativeContainer} />
            {!gisLoaded && (
              <button
                type="button"
